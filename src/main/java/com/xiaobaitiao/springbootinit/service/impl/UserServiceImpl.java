...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    @Override
    public boolean isAdmin(com.xiaobaitiao.springbootinit.model.entity.User user) {
    ...
    @Override
    public LoginUserVO getLoginUserVO(com.xiaobaitiao.springbootinit.model.entity.User user) {
        if (user == null) {
            return null;
        }
    ...
    @Override
    public UserVO getUserVO(com.xiaobaitiao.springbootinit.model.entity.User user) {
        if (user == null) {
            return null;
        }
